...
plot(ages.ma, jout$BUGSoutput$sims.list$tempC[1,], type="l", axes = FALSE, xlab = "", ylab = expression(paste("SST ",degree,"C")), xlim = c(56.000,55.700), ylim = c(32,44), col=rgb(red=0, green=0, blue=0, alpha=0.2), lwd=0.3)
for (i in 2:500) {
...
plot(ages.ma, jout$BUGSoutput$sims.list$sal[1,], type="l", axes = FALSE, xlab = "", ylab = "", xlim = c(56.000,55.700),  ylim = c(31.5,36), col=rgb(red=0, green=0, blue=0, alpha=0.2), lwd=0.3)
for (i in 2:500) {
